...
module.exports = function (grunt) {
  ...
  var appConfig = {
    app: require('./bower.json').appPath || 'prisoners',
    dist: 'dist'
  };
      ...
      livereload: {
        options: {
          ...
          middleware: function (connect) {
            return [
              modRewrite(['!\\.html|\\.js|\\.css|\\.png|\\.jpg|\\.gif|\\woff|\\woff2$ /index.html [L]']),
              connect.static('.tmp'),
              connect().use(
                '/bower_components',
              ...
              connect().use(
                '/css',
                connect.static('./prisoners/css')
              ),
              connect().use(
                '/prisoners/lang',
                connect.static('./prisoners/lang')
              ),
